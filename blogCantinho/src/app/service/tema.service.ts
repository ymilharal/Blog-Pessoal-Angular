...
export class TemaService {
  ...
  getAllTema(): Observable<Tema[]>{
    return this.http.get<Tema[]>('https://cantinhocafe.herokuapp.com/tema', this.token)
  ...
  getByNomeTema(nome: string): Observable<Tema[]>{
    return this.http.get<Tema[]>(`https://cantinhocafe.herokuapp.com/tema/nome/${nome}`, this.token)
  }
